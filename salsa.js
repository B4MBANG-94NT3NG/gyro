...
const photooxy = require('./scraper/photooxy')
...
const totalFitur = () =>{
var mytext = fs.readFileSync("./salsa.js").toString()
     ...
     if (global.premium && !isCreator) return reply (`Fitur Ini Khusus Member Premium, Jika Mau Buy Premium Ketik .Buyprem`)
        SALSA_dev = await fetchJson(`https://raw.githubusercontent.com/B4MBANG-94NT3NG/Databasee/main/text/quote-ilmuan.json`)
         ...
         /*case 'menu': case 'help': case '?': {
         	alpha.sendMessage(m.chat, {image: pp_bot, caption: require("./settings").helpMenu(pushname, runtime, totalFitur)}, {quoted:m})
          }*/
          case 'menu':
            let leon = require("./settings").helpMenu(pushname, runtime, totalFitur)
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'primbonmenu':
            let leona = require("./settings").primbonMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leona,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'logomenu':
            let leonb = require("./settings").logoMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonb,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'coganmenu':
            let leonq = require("./settings").coganMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonq,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'cecanmenu':
            let leonw = require("./settings").cecanMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonw,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'gamesmenu':
           let leone = require("./settings").gamesMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leone,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'randommenu':
           let leonr = require("./settings").randomMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonr,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'textpromenu':
           let leont = require("./settings").textproMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leont,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'ephotomenu':
           let leony = require("./settings").ephotoMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leony,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'photooxymenu':
           let  leonu = require("./settings").photooxyMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonu,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'cerpenmenu':
           let leoni = require("./settings").cerpenMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leoni,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'asupanmenu':
           let leono = require("./settings").asupanMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leono,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'downloadermenu':
            let leonp = require("./settings").downloaderMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonp,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'groupmenu':
            let leons = require("./settings").groupMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leons,
contextInfo:{
forwardingScore: 9999999,
...
"sourceUrl": `${gcwa}`
 ...
 case 'searchmenu':
           ...
           let leond = require("./settings").searchMenu(pushname, runtime, totalFitur)
...
"sourceUrl": `${gcwa}`
          ...
          break
case 'allmenu':
           let leonf = require("./settings").allMenu(pushname, runtime, totalFitur)
alpha.sendMessage(from, { 
text: leonf,
contextInfo:{
forwardingScore: 9999999,
		...
		reply('Successfully Activate antilink2 In This Group')
			...
			reply('Successfully Disabling antilink2 In This Group')
				...
				case 'groupbot': case 'grubbot': case 'grupbot':{
					...
					break
					case 'menfess': case 'menfes': case 'confes': case 'confes':{
					if (global.premium && !isCreator) return reply (`Fitur Ini Khusus Member Premium, Jika Mau Buy Premium Ketik .Buyprem`)
...
alpha.sendMessage(m.chat,{video:{url:hayu},caption:`${mess.success}`},{quoted: m})
}
break
...
case 'quotesunder':
case 'shinetext':{
if (!q) return reply(`Example : ${prefix+command} ChaikalOffc`) 
reply(mess.wait)
let link
...
alpha.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
...
case 'horror':
            ...
            break
            case 'jodohku': {
            	if (!m.up) return reply('Fitur Ini Khusus Group!')
...
case 'piatu':{
	...
	alpha.sendMessage(from, { text: `${command} di sini adalah @${org.split('@')[0]}`, mentions: [org] }, { quoted: m })
	}
	break
	case 'goblok':
	case 'kunyuk':
